...
public class Cell {
	...
	public Cell(int id, GridNode[] nodes) {

		this.id = id;

		this.nodes = new GridNode[8];
	...
	public double[] shapeFunction(Vector3 position) {

		Vector3 xi = localCoordinate(position);
	...
	public Vector3 localCoordinate(Vector3 position) {
	...
	public Vector3[] shapeGradient(Vector3 position) {
