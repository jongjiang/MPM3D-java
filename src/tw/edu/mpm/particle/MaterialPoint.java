...
public class MaterialPoint {
	...
	/*
	 * ========================================================
	 * Momentum Update v(n+1)=v(n)+aΔt
	 * ========================================================
	 */
	public void updateVelocity(double dt) {
		velocity.addInPlace(acceleration.multiply(dt));
	}

	/*
	 * ========================================================
	 * Position Update x(n+1)=x(n)+vΔt
	 * ========================================================
	 */
	public void updatePosition(double dt) {
		position.addInPlace(velocity.multiply(dt));
	}
